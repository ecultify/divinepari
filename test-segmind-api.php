...
try {
    ...
    $sourceImagePath = __DIR__ . '/public/images/posters/Option1M.avif'; // Change to an actual image path
    $targetImagePath = __DIR__ . '/public/images/posters/Option2M.avif'; // Change to an actual image path
